  ...
  return (
    <PageContainer className="max-w-4xl py-8 sm:py-10">
      <header className="mb-8">
        ...
        <h1 className="mt-3 text-4xl font-extrabold sm:text-5xl">Data</h1>
      ...
      <SectionHeader eyebrow="Raw data" title="What the engine reads" />
      ...
      <SectionHeader eyebrow="Derived data" title="What the engine writes" />
      ...
      <Card variant="flat" className="mt-6 p-5">
        <h2 className="font-bold">Import and export</h2>
        <p className="text-muted mt-1.5 text-sm leading-relaxed">
          Provider imports run from{" "}
          <Link href="/admin/sync" className="text-gold hover:underline">
            Data Sync
          </Link>
